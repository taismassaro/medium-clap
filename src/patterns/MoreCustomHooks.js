...
// Custom hook for clap state

function useClapState (initialState = INITIAL_STATE) {
  ...
  return [state, updateClapState]
}

// Custom hook for useEffect after mount
